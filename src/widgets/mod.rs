...
impl WidgetParams for NoneWidget {
    // This is a bit weird but should be absolutely fine.
    type Widget = Self;
}
...
impl Widget for NoneWidget {
    ...
    fn build(_: &mut Self::Params, _: LayoutConstraint, _: &mut Piet, _: &Theme) -> Self {
        NoneWidget
    }

    fn update(&mut self, _: &mut Self::Params, _: LayoutConstraint, _: &mut Piet, _: &Theme) {}
...
// impl WidgetParams for NoneElement {
